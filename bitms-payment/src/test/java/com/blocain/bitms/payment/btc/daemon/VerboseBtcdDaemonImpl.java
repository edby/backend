...
{
    public VerboseBtcdDaemonImpl(BtcdClient btcdProvider) throws BitcoindException, CommunicationException
    {
        super(btcdProvider);
    ...
    public boolean isMonitoring(Notifications notificationType)
    {
        ...
        System.out.printf("'%s' notification monitor status was: '%s'\n", notificationType.name(), ((isMonitoringX == true) ? "ACTIVE" : "INACTIVE"));
