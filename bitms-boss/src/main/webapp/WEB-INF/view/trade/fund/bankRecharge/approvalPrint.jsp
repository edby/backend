...
<div style="max-width:800px;margin:20px auto;" >
    <div style="overflow: hidden;width:100%;">
        <h5 style="float: left;display: inline-block;margin-top:0px;">
            <span>TRANS ID:</span>
            <span>${accountFundCurrent.transId}</span>
        </h5>
        <img src="${ctx}/static/style/images/biex.svg" style="display: inline-block;float: right; " />
    </div>
    <br />
    <div style="overflow: hidden;">
        <h1 style="margin: 0px auto;width: 500px;text-align: center;margin-bottom: 10px;">Application for Recharge</h1>
    ...
    <div style="overflow: hidden;margin-top:20px;">
        <h3 style="margin-bottom: 5px;">APPLICATION FOR CURRENT DEPOSIT RECORD</h3>
        <table style="width: 100%;" border="1" cellspacing="0">
            ...
            <tr>
                <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${accountFundCurrent.createDate}"/></td>
                <td>${accountFundCurrent.transId}</td>
                <td><fmt:formatNumber value="${accountFundCurrent.amount}" pattern="#,##0.000000"  />${coin}</td>
