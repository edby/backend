...
public class Value
{
    ...
    public int asInt()
    {
        ...
        else if (isBytes()) { return new BigInteger(1, asBytes()).intValue(); }
        return 0;
    }
    ...
    public long asLong()
    {
        ...
        else if (isBytes()) { return new BigInteger(1, asBytes()).longValue(); }
        return 0;
    }
    ...
    public String asString()
    {
        ...
        else if (isString()) { return (String) value; }
        return "";
    }
    ...
    public byte[] asBytes()
    {
        ...
        else if (isString()) { return asString().getBytes(); }
    ...
    public Value get(int index)
    {
        if (isList())
        {
            ...
            if (asList().size() <= index) { return new Value(null); }
            if (index < 0) { throw new RuntimeException("Negative index not allowed"); }
    ...
    public boolean isReadableString()
    {
        ...
        if (data.length == 1 && data[0] > 31 && data[0] < 126) { return true; }
        for (byte aData : data)
        {
    ...
    public int length()
    {
        ...
        else if (isString()) { return asString().length(); }
        return 0;
    }
