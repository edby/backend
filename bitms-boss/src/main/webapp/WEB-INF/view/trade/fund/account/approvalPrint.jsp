...
<div style="max-width:800px;margin:20px auto;" >
    <div style="overflow: hidden;">
        <h5 style="float: left;display: inline-block;margin-top:0px;">
            ...
            <c:if test="${!empty trans.pendingApproval}">
                <br />
                <span>APPROVAL ID:</span>
                <span>${trans.pendingApproval}&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;&#12288;</span>
            </c:if>
            <c:if test="${!empty trans.transId}">
                <br />
                <span>TRANS ID:</span>
                <span>${trans.transId}</span>
            </c:if>
        </h5>
        <img src="${ctx}/static/style/images/biex.svg" style="display: inline-block;float: right;position:absolute;z-index: 100; " />
    </div>
    <br />
    <div style="overflow: hidden;">
        ...
        <span style="float: right;display: block;">
			...
			<span>${certification.surname}&nbsp;${certification.realname}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		</span>
        <br>
        <span style="float: right;display: block;">
                    ...
                    <c:choose>
                        <c:when test="${item.id != accountFundCurrent.id }">
                            <tr>
                                ...
                                <td><fmt:formatNumber value="${item.occurAmt-item.netFee}" pattern="#,##0.000000"  />${coin}</td>
    ...
    <div style="overflow: hidden;margin-top:20px;">
        ...
        <table style="width: 100%;" border="1" cellspacing="0">
            ...
            <tr>
                <td>${accountFundCurrent.currentDate}</td>
                <td>${accountFundCurrent.withdrawAddr}</td>
                <td><fmt:formatNumber value="${accountFundCurrent.occurAmt-accountFundCurrent.netFee}" pattern="#,##0.000000"  />${coin}</td>
