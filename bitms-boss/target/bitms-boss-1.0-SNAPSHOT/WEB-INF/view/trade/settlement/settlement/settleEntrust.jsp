...
<script type="text/javascript">
    var settleEntrustGrid;
    $(function () {
        settleEntrustGrid = $('#settleEntrustGrid').datagrid({
            url: '${ctx}/settlement/settlement/settleEntrust/data',
            queryParams:{
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:true">
        <table id="settleEntrustGrid" data-options="fit:true,border:false"></table>
    </div>
</div>
