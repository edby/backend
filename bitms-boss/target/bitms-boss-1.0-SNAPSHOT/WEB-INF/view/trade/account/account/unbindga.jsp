...
<script type="text/javascript">
    $(function() {
        $('#clearAccountGaForm').form({
            url : '${ctx}/account/account/clearga',
            onSubmit : function() {
                progressLoad();
            ...
            success : function(result) {
                ...
                if (result.code == 200) {
                    ...
                    $('#clearAccountGaForm').find('input[name="csrf"]').val(result.csrf);
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form:form id="clearAccountGaForm" method="post">
            <table class="grid">
                <tr>
                    <td>登录名</td>
                    <td>
