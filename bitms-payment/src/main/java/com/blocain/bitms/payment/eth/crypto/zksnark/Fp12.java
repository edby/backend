 ...
 */
package com.blocain.bitms.payment.eth.crypto.zksnark;
...
class Fp12 implements Field<Fp12>
{
    ...
    public String toString()
    {
        return String.format("Fp12 (%s; %s)\n" + "     (%s; %s)\n" + "     (%s; %s)\n" + "     (%s; %s)\n" + "     (%s; %s)\n" + "     (%s; %s)\n", a.a.a, a.a.b, a.b.a,
                a.b.b, a.c.a, a.c.b, b.a.a, b.a.b, b.b.a, b.b.b, b.c.a, b.c.b);
    }
    
    static final Fp2[] FROBENIUS_COEFFS_B = new Fp2[]{new Fp2(BigInteger.ONE, BigInteger.ZERO),
            ...
            new Fp2(new BigInteger("21888242871839275220042445260109153167277707414472061641714758635765020556617"), BigInteger.ZERO),
            ...
            new Fp2(new BigInteger("21888242871839275220042445260109153167277707414472061641714758635765020556616"), BigInteger.ZERO),
            ...
            new Fp2(new BigInteger("21888242871839275222246405745257275088696311157297823662689037894645226208582"), BigInteger.ZERO),
