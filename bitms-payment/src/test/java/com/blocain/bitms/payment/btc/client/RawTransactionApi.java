...
import com.blocain.bitms.payment.btc.core.domain.Output;
import com.blocain.bitms.payment.btc.core.domain.OutputOverview;
import com.blocain.bitms.payment.btc.core.domain.enums.SigHashTypes;
...
public class RawTransactionApi
{
    public static void main(String[] args) throws Exception
    {
        ...
        client.createRawTransaction(Arrays.asList(new OutputOverview[]{new OutputOverview("c61706760cbae899d8ef130c6d6405ce67c163340c7f78a5388c1adb44e271a7", 0)}),
        ...
        client.decodeRawTransaction("01000000019851e46f856eaa07c129e37d8ebfbc4e99f764e4623dd344dabf6718"
                ...
                + "6ddccf8488acd8470300000000001976a9140ebec5470aec62ac2731ac536f4860768e31983288ac0000" + "0000");
        client.decodeScript("5321021a971b74e19dbfa8d72fba6900bb49f6301cc8b7f86d1a5dd59397d3bdce88782103"
                ...
                + "dc02916c3d565cb02c50b2aaabd9394eb2bd024692b57602c95a86a9c3dabbbaa163db340cbd58506c11" + "ec9bf757c88854ae");
        ...
        client.sendRawTransaction("0100000001a771e244db1a8c38a5787f0c3463c167ce05646d0c13efd899e8ba0c"
                ...
                + "00001976a9141083bfc4f51e3556a7908dde8a7d32e827e1212d88ace03cc801000000001976a914384c" + "891aeb1caee8c44039031a2d874228e5b4cd88ac00000000");
        client.sendRawTransaction("01000000019851e46f856eaa07c129e37d8ebfbc4e99f764e4623dd344dabf6718e2"
                ...
                + "eab273e95a623b45fa511345836ddccf8488acd8470300000000001976a9140ebec5470aec62ac2731ac" + "536f4860768e31983288ac00000000", true);
        ...
        client.signRawTransaction(
                "01000000019851e46f856eaa07c129e37d8ebfbc4e99f764e4623dd344dabf6718e2"
                        + "d66f650000000000ffffffff0300ef1c0d000000001976a9141083bfc4f51e3556a7908dde8a7d32e827"
                        + "e1212d88ac580f0200000000001976a914af7d3ceab273e95a623b45fa511345836ddccf8488acd84703"
                        + "00000000001976a9140ebec5470aec62ac2731ac536f4860768e31983288ac00000000",
                Arrays.asList(new Output[]{new Output("656fd6e21867bfda44d33d62e464f7994ebcbf8e7de329c1" + "07aa6e856fe45198", 0,
                        "76a9141083bfc4f51e3556a7908dde8a7d32e827e1212d88ac", null)}));
        client.signRawTransaction(
                "01000000019851e46f856eaa07c129e37d8ebfbc4e99f764e4623dd344dabf6718e2"
                        + "d66f650000000000ffffffff0300ef1c0d000000001976a9141083bfc4f51e3556a7908dde8a7d32e827"
                        + "e1212d88ac580f0200000000001976a914af7d3ceab273e95a623b45fa511345836ddccf8488acd84703"
                ...
                Arrays.asList(new Output[]{new Output("656fd6e21867bfda44d33d62e464f7994ebcbf8e7de329c1" + "07aa6e856fe45198", 0,
                        "76a9141083bfc4f51e3556a7908dde8a7d32e827e1212d88ac", null)}),
                Arrays.asList(new String[]{"cNbvKQrwsEtwriHYK9ji1k7BZqggD3ZezXfkWJZFNp" + "6PmSTfWEkT"}));
        client.signRawTransaction(
                "01000000019851e46f856eaa07c129e37d8ebfbc4e99f764e4623dd344dabf6718e2"
                        + "d66f650000000000ffffffff0300ef1c0d000000001976a9141083bfc4f51e3556a7908dde8a7d32e827"
                        + "e1212d88ac580f0200000000001976a914af7d3ceab273e95a623b45fa511345836ddccf8488acd84703"
                ...
                Arrays.asList(new Output[]{new Output("656fd6e21867bfda44d33d62e464f7994ebcbf8e7de329c1" + "07aa6e856fe45198", 0,
                        "76a9141083bfc4f51e3556a7908dde8a7d32e827e1212d88ac", null)}),
                Arrays.asList(new String[]{"cNbvKQrwsEtwriHYK9ji1k7BZqggD3ZezXfkWJZFNp" + "6PmSTfWEkT"}), SigHashTypes.NONE.getName());
    }
}