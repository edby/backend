...
/**
 * 钱包转账流水表 实体对象
 * <p>File：WalletTransferCurrent.java</p>
 * <p>Title: WalletTransferCurrent</p>
 * <p>Description:WalletTransferCurrent</p>
 * <p>Copyright: Copyright (c) May 26, 2015</p>
 * <p>Company: BloCain</p>
 * @author Playguy
 * @version 1.0
 */
@ApiModel(description = "钱包转账流水表")
public class WalletTransferCurrent extends GenericEntity
{
    ...
    /**资产发生方向(减少decrease)*/
    @NotNull(message = "资产发生方向(减少decrease)不可为空")
    @ApiModelProperty(value = "资产发生方向(减少decrease)", required = true)
