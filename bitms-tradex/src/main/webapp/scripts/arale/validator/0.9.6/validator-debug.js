...
define("arale/validator/0.9.6/core-debug", ["$-debug", "arale/validator/0.9.6/async-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/validator/0.9.6/utils-debug", "arale/validator/0.9.6/rule-debug", "arale/validator/0.9.6/item-debug"], function (require, exports, module) {
    var $ = require("$-debug"), async = require("arale/validator/0.9.6/async-debug"),
        Widget = require("arale/widget/1.1.1/widget-debug"), utils = require("arale/validator/0.9.6/utils-debug"),
        Item = require("arale/validator/0.9.6/item-debug");
    var validators = [];
    var setterConfig = {
        value: $.noop,
        setter: function (val) {
...
define("arale/validator/0.9.6/rule-debug", ["$-debug", "i18n"], function (require, exports, module) {
    var $ = require("$-debug"), i18n = require('i18n'), rules = {}, messages = {};
    ...
    addRule("password", /^(?=.*?[0-9])(?=.*?[A-Z])(?=.*?[a-z])[0-9A-Za-z!-)]{8,}$/, i18n.prop('validate.password'));
...
define("arale/validator/0.9.6/item-debug", ["$-debug", "arale/validator/0.9.6/utils-debug", "arale/validator/0.9.6/rule-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/validator/0.9.6/async-debug"], function (require, exports, module) {
    var $ = require("$-debug"), utils = require("arale/validator/0.9.6/utils-debug"),
        Widget = require("arale/widget/1.1.1/widget-debug"), async = require("arale/validator/0.9.6/async-debug"),
        Rule = require("arale/validator/0.9.6/rule-debug");
    var setterConfig = {
        value: $.noop,
        setter: function (val) {
            return $.isFunction(val) ? val : utils.helper(val);
