...
<div id="index_layout">
    <div data-options="region:'north',border:false" style="overflow: hidden;">
        <div>
                <span style="float: right; padding-right: 20px; margin-top: 15px; color: #333">
                    <i class="fi-torso"></i>
                    <b>${object.userName}(${object.trueName})</b>&nbsp;&nbsp;
    ...
    <div data-options="region:'south',border:false"
         style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee">Copyright © 2017 power by <a href="http://www.blocain.com/" target="_blank">BloCain</a></div>
</div>
<div id="tabsMenu">
