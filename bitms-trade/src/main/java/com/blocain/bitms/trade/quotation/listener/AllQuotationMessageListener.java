...
import com.blocain.bitms.trade.quotation.websocket.AllQuotationWebSocketHandler;

/**
 * 全行情推送消息监听器
 */
public class AllQuotationMessageListener extends BaseMessageListener
{
    private AllQuotationWebSocketHandler quotationWebSocketHandler;
    ...
    public void setQuotationWebSocketHandler(AllQuotationWebSocketHandler quotationWebSocketHandler)
    {
