...
public abstract class AgentConfigurator
{
    ...
    public Properties checkNodeConfig(Properties nodeConfig)
    {
        for (NodeProperties property : getRequiredProperties())
        {
            ...
            {
                LOG.warn("-- checkNodeConfig(..): node property '{}' not set; reverting to " + "default value '{}'", property.getKey(), property.getDefaultValue());
    ...
    public Properties toProperties(Object ... values)
    {
        ...
        List<NodeProperties> requiredProperties = new ArrayList<NodeProperties>(getRequiredProperties());
