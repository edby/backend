...
<script type="text/javascript">
    var platLossShareConfirmDataGrid;
    $(function () {
        platLossShareConfirmDataGrid = $('#platLossShareConfirmDataGrid').datagrid({
            url: '${ctx}/settlement/settlement/current/data',
            queryParams:{
                accountAssetType:'<%=FundConsts.ACCOUNT_ASSET_TYPE_CONTRACT_ASSET %>',
                businessFlag:'<%=FundConsts.SYSTEM_BUSSINESS_FLAG_PLAT_SHARE_OF_LOSSES_VCOIN_MONEY%>',
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:true">
        <table id="platLossShareConfirmDataGrid" data-options="fit:true,border:false"></table>
    </div>
</div>	
