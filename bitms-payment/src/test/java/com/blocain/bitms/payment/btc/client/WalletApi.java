...
public class WalletApi
{
    public static void main(String[] args) throws Exception
    {
        ...
        client.addMultiSigAddress(2,
                Arrays.asList(new String[]{"mwMpStsPJUfhRX5FFs8ppU7fWWfhjuKvL4", "myN6xmzRVHvsAEXv4MRzoNsoqNeuispybG", "mpgyUpBSBvVrPewGz26LmXSfRkVpq1tGV3"}));
        client.addMultiSigAddress(3,
                Arrays.asList(new String[]{"mwMpStsPJUfhRX5FFs8ppU7fWWfhjuKvL4", "myN6xmzRVHvsAEXv4MRzoNsoqNeuispybG", "mpgyUpBSBvVrPewGz26LmXSfRkVpq1tGV3"}),
                "jointAccountB");
        ...
        client.lockUnspent(false, Arrays.asList(new OutputOverview[]{new OutputOverview("ff534734f74fc4ecffe1588a6554898717bb5bbc58688ddcd9a0dede132bfd13", 1)}));
        client.move("accountA", "accountB", new BigDecimal("0.53006000"));
        client.move("accountA", "accountB", new BigDecimal("0.00200000"), 0, "Sample move: " + "an off-chain transfer of 0.002 BTC from 'accountA' to 'accountB'.");
        ...
        client.sendFrom("treasury", "mz6s3qBsifGLyJMcjxWabJ9z3Zf95Etods", new BigDecimal("0.007"), 4,
                "Sample transaction: a payment of 0.007 BTC to 'supplierF' for services rendered.", "supplierF");
        ...
        {
            {
                ...
                put("n3y8BpckkDDGMtSq7d2Yx46EYenyUit3Jc", new BigDecimal("0.007"));
            }
        }, 100);
        client.sendMany("treasury", new HashMap<String, BigDecimal>()
        {
            {
                ...
                put("n3y8BpckkDDGMtSq7d2Yx46EYenyUit3Jc", new BigDecimal("0.0015"));
            }
        }, 100, "Sample transaction: a payment of 0.0015 BTC to both 'supplierA' and 'supplierB' for" + " services rendered.");
