...
import com.blocain.bitms.payment.btc.daemon.notification.NotificationMonitor;
...
public class BtcdDaemonImpl implements BtcdDaemon
{
    ...
    public boolean isMonitoringAny()
    {
        ...
        {
            Future<Void> monitorHandle = futures.get(notificationType);
            if ((monitorHandle != null) && (!monitorHandle.isDone())) { return true; }
        }
        return false;
    }
    ...
    public boolean isMonitoringAll()
    {
        ...
        {
            Future<Void> monitorHandle = futures.get(notificationType);
            if ((monitorHandle == null) || (monitorHandle.isDone())) { return false; }
        }
        return true;
    }
