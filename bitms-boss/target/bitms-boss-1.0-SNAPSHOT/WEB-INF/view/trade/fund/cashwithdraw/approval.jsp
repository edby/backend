...
<script type="text/javascript">
    $(function() {
        $('#editcashWithdrawAppForm').form({
            url : '${ctx}/fund/cashwithdraw/approval/approval',
            onSubmit : function() {
            ...
            success : function(result) {
                ...
                if (result.code == ajax_result_success_code) {
                    ...
                    $('#editcashWithdrawAppForm').find('input[name="csrf"]').val(result.csrf);
                }
                parent.$.modalDialog.openner_dataGrid.datagrid('reload');
    ...
    $(document).ready(function(){
        ...
        $("#editcashWithdrawAppForm").parent().css("overflow-y","scroll");
    });
</script>
<div id="approvalWin" class="easyui-layout" data-options="fit:true,border:false" style="">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form:form id="editcashWithdrawAppForm" method="post">
                ...
                <tr>
                    <td colspan="6" align="center">
                        GA验证码： <input id="gaCode" name="gaCode" type="text" placeholder="请输入GA验证码" class="easyui-validatebox easyui-textbox" style="width: 374px;"
                                      data-options="validType:['length[6,6]'],precision:0" value="">
                    </td>
                </tr>
            </table>
        </form:form>
