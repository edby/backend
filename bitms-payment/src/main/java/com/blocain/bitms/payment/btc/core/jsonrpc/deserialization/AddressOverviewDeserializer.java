...
import com.blocain.bitms.payment.btc.core.domain.AddressOverview;
...
public class AddressOverviewDeserializer extends JsonDeserializer<AddressOverview>
{
    ...
    @Override
    public AddressOverview deserialize(JsonParser parser, DeserializationContext context) throws IOException, JsonProcessingException
    {
        List<Object> propertyList = context.readValue(parser, context.getTypeFactory().constructCollectionType(ArrayList.class, Object.class));
