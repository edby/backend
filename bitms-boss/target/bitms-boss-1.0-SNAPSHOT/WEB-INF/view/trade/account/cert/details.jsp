...
<script type="text/javascript" src="${ctx}/static/js/jquery.jqprint-0.3.js" charset="utf-8"></script>
...
<div id="approvalWin" class="easyui-layout" data-options="fit:true,border:false" style="">
    <div id="printArea" data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        ...
        <button type="button" class="printBtn" onclick="print()">打印</button>
    </div>
</div>