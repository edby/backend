package com.blocain.bitms.payment.btc;
...
import com.blocain.bitms.payment.btc.core.domain.PeerNode;
...
import com.blocain.bitms.payment.btc.daemon.BtcdDaemon;
import com.blocain.bitms.payment.btc.daemon.BtcdDaemonImpl;
...
public class IncubatorMain
{
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("Testing 'CollectionUtils.asMap(..)' #2: "
                + CollectionUtils.asMap("addressA", new BigDecimal("0.03"), "addressB", new BigDecimal("0.05"), "addressC", new BigDecimal("0.09")));
        ...
        String decodedVersion = StringUtils
                .join(CollectionUtils.mergeInterlaced(StringUtils.split(StringUtils.pad(nodeVersion2, 8, '0', true), 2), CollectionUtils.duplicate(".", 4)));
