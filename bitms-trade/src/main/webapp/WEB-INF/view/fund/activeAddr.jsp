                ...
                <div class="col-sm-offset-4 col-sm-4 bitms-bg1 mt30 mb30 bitms-b bitms-radius6 px0">
                    <c:if test="${status == 'yes' }">
                        <div class="text-center mt30">
                            ...
                            <h3 class="mt30 bitms-c2"><fmt:message key="fund.raise.active.success"/></h3>
                        </div>
                        <div class="text-center bitms-bg2 mt30 py50 bitms-radius6">
                            <span class="bitms-c2"><fmt:message key="fund.raise.withdrawalsAddr"/><fmt:message key="fund.raise.active.success"/></span>
                        </div>
                    </c:if>
                    <c:if test="${status == 'no' }">
                        <div class="text-center mt30">
                        ...
                        <div class="text-center bitms-bg2 mt30 py50 bitms-radius6">
                            <span class="bitms-c2"><fmt:message key="fund.raise.withdrawalsAddr"/><fmt:message key="fund.raise.confirm.success"/></span>
                        </div>
                    </c:if>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        window.setTimeout("toUrl()",10000);//10秒钟跳转
    });
</script>
</body>
</html>
