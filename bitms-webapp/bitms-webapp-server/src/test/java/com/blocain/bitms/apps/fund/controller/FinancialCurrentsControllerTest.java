 ...
 * @version 1.0
 */
public class FinancialCurrentsControllerTest
{
    public static String root = "http://localhost:8080/";
    
    @Test
    public void financialCurrentsList() throws Exception
    {
        BitmsClient client = new DefaultBitmsClient(root + "fund/currents/financialCurrentsList", DemoController.privateKey, "0123456789");
        BitmsRequest request = new BitmsRequest();
        request.setNeedEncrypt(true);
        CurrentsRequest financialCurrents = new CurrentsRequest();
        financialCurrents.setAuthToken("G6/3qGFN9TX7JVerr/NCdMcbf9A0MLnc0Tluybe3sCX5NgsI0ophny3niJcFCE7N7Xs/xQgM8x/+GlVCim5+fjC0lmdCKHFXa86ejw93dkusQ7zmJI1IcL7u9enc57k1CZE8Eb2MOgmH/QF/ipRVCauGcQWX+L9PlF5BG3+/RO2EI6rNQMj/CA==");
        financialCurrents.setSymbol("eth");
        financialCurrents.setIsHis("no");
        request.setBizModel(financialCurrents);
