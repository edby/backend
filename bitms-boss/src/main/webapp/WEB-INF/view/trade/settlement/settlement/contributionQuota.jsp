...
<script type="text/javascript">
    var contributionQuota;
    $(function () {
        contributionQuota = $('#contributionQuota').datagrid({
            url: '${ctx}/settlement/settlement/contributionQuota/data',
            queryParams:{
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:true">
        <table id="contributionQuota" data-options="fit:true,border:false"></table>
    </div>
</div>	
