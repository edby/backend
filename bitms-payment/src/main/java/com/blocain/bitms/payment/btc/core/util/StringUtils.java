...
public final class StringUtils
{
    ...
    {
        if (text == null) { throw new IllegalArgumentException(Errors.ARGS_NULL.getDescription()); }
    ...
    {
        if (alphabet == null) { throw new IllegalArgumentException(Errors.ARGS_NULL.getDescription()); }
        if (length < 0)
        {
    ...
    {
        return new String(new char[count]).replaceAll(Character.toString(Constants.CHAR_NULL), Character.toString(character));
    }
    ...
    {
        if (items == null) { throw new IllegalArgumentException(Errors.ARGS_NULL.getDescription()); }
        StringBuilder result = new StringBuilder();
    ...
    {
        if (texts == null) { throw new IllegalArgumentException(Errors.ARGS_NULL.getDescription()); }
