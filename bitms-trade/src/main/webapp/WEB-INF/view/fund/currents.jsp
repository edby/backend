                ...
                <div class="panel clearfix">
                    ...
                    <div class="col-sm-12 px0">
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <%--<button type="button" class="btn btn-primary" id="downloadBtn">&lt;%&ndash;下载&ndash;%&gt;<fmt:message key="download" /></button>--%>
                        </div>
                    </div>
                </div>
                <div class="panel clearfix">
...
<script id="list_tpl" type="text/html">
    ...
    <tr class="test">
        ...
        <td>{{$plusMinusFlag2 $value.fee,$value.occurDirect}}</td>
...
<script>
    ...
    seajs.use([ 'pagination', 'template', 'moment','my97DatePicker' ], function(Pagination, Template, moment) {
        ...
        renderPage = new Pagination({
            ...
            url : "${ctx}/fund/currents/currentsList",
        ...
        $('#downloadBtn').on('click', function(){
            $("#currentsForm").append('<input id="currentsFormpage" name="page" value="'+pageNo+'" type="hidden"/>');
            $("#currentsForm").append('<input id="currentsFormrows" name="rows" value="10" type="hidden"/>');
            $("#currentsForm").submit();
            $("#currentsFormpage").remove();
            $("#currentsFormrows").remove();
        });
    ...
    $(function(){
        $.ajax({
            url : '${ctx}/common/stockinfo/isExchange',
            type : "get",
            cache : false,
        ...
        selectType('<%=FundConsts.WALLET_BTC_TYPE%>');
    });

    function selectType()
    {
        var array=["wallet2Contract","contract2Wallet",
                "matchTradeVCoinMoneySpotBuyEntrust","matchTradeVCoinMoneySpotSellEntrust",
                "matchTradeSpotBuyEntrustWithdraw","matchTradeSpotSellEntrustWithdraw",
                "matchTradeSpotBuyEntrustDeal","matchTradeSpotSellEntrustDeal",
                "matchTradeSpotReturnVCOIN", "matchTradeSpotReturnCNY",
                "matchTradepotFeeCNY", "matchTradeSpotFeeVCOIN",
                "matchTradeAutoBorrow","matchTradeAutoRepayment",
                "matchTradeSpotClosePositionAssetTransfer","matchTradeSpotClosePositionDebitTransfer",
                "settlementMoneyTransfer","settlementVCoinTransfer","settlementAutoBorrowMoney",
                "settlementAutoBorrowVCoin","settlementMoveVCoinTransfer","settlementMoveMoneyTransfer","settlementSuperAccountVCOINAssetToZrea",
                "settlementSuperAccountVCOINDebitToZrea","settlementSuperAccountMONEYAssetToZrea","settlementSuperAccountMONEYDebitToZrea",
                "settlementContributionQuotaVcoinMoveIncrease","settlementContributionQuotaVcoinMoveDecrease","settlementContributionQuotaMoneyMoveIncreaset",
                "settlementContributionQuotaMoneyMoveDecrease","settlementContributionQuotaVcoinDeductionIncrease",
                "settlementContributionQuotaVcoinDeductionDecrease","settlementContributionQuotaMoneyExchangeDecrease",
                "settlementContributionQuotaVcoinExchangeIncrease","settlementContributionQuotaMoneyExchangeIncrease",
                "settlementContributionQuotaVcoinExchangeDecrease","platSettlementVCoinMoneyExchangMoneyToVCoin","platSharingOfLossesVCoinMoney"];
