...
<script type="text/javascript">
    var usdxHaveMoveDataGrid;
    $(function () {
        usdxHaveMoveDataGrid = $('#usdxHaveMoveDataGrid').datagrid({
            url: '${ctx}/settlement/settlement/current/data',
            queryParams:{
                accountAssetType:'<%=FundConsts.ACCOUNT_ASSET_TYPE_CONTRACT_ASSET %>',
                businessFlag:'<%=FundConsts.SYSTEM_BUSSINESS_FLAG_PLAT_SETTLEMENT_VCOIN_MONEY_EXCHANGE_MONEY_TO_VCOIN %>',
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:true">
        <table id="usdxHaveMoveDataGrid" data-options="fit:true,border:false"></table>
    </div>
</div>	
